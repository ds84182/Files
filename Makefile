...
BUILD		:=	build
SOURCES		:=	citro3d/source citro3d/source/maths source source/activity source/animation source/fmt source/graphics source/style source/ui source/ui/elements source/ui/layouts source/utils
DATA		:=	data
...
$(BUILD):
	@[ -d $@ ] || mkdir -p $@
	@mkdir -p $(sort $(foreach file,$(OFILES),$@/$(dir $(file))))

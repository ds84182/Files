...
float FastOutSlowInInterpolator(float input) {
	// Constants and concept from the Android Support Library (support-v4)
	const float values[] = {
	...
	static float stepSize = 1.0f/float(length-1);
	...
	// Calculate index
	int position = std::min(int(input * (length - 1)), length - 2);
...
float LinearOutSlowInInterpolator(float input) {
	// Constants and concept from the Android Support Library (support-v4)
	const float values[] = {
...
float FastOutLinearInInterpolator(float input) {
	// Constants and concept from the Android Support Library (support-v4)
	const float values[] = {
